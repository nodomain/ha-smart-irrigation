...
for var in ZONE1_SWITCH ZONE2_SWITCH ZONE3_SWITCH ZONE4_SWITCH IPHONE_DEVICE ZONE1_DEVICE_ID ZONE4_DEVICE_ID GATEWAY_CONNECTION_ENTITY ZONE1_CONNECTION_ENTITY ZONE4_CONNECTION_ENTITY ZONE1_SENSOR ZONE2_SENSOR ZONE3_SENSOR ZONE4_SENSOR WATER1_SWITCH WATER2_SWITCH WATER3_SWITCH; do
  if [[ -z "${!var:-}" ]]; then
